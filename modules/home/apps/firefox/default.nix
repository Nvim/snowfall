    ...
    programs.firefox = {
      ...
      profiles.${profileName} = {
        ...
        userChrome =
          ...
          ''
            :root {
            	--tab-active-bg-color: ${colors.base0D};
            	--tab-inactive-bg-color: ${colors.base01};
            	--tab-active-fg-fallback-color: ${colors.base07};		/* color of text in an active tab without a container */
            	...
            	--urlbar-not-focused-bg-color: ${colors.base02};
